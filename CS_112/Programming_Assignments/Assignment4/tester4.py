...
class AllTests (unittest.TestCase):
	...
	############################################################################
    # swap_text tests - 10pts
    def test_swap_text_1(self):
        '''swap_text("hello") --> "ehllo"'''
        self.assertEqual(swap_text("hello"), "ehllo")

    def test_swap_text_2(self):
        '''swap_text("Party for Zoro!") --> "aPtr yof roZor!"'''
        self.assertEqual(swap_text("Party for Zoro!"), "aPtr yof roZor!")

    def test_swap_text_3(self):
        '''swap_text("") --> ""'''
        self.assertEqual(swap_text(""), "")

    def test_swap_text_4(self):
        '''swap_text("A") --> "A"'''
        self.assertEqual(swap_text("A"), "A")

    def test_swap_text_5(self):
        '''swap_text("Hi") --> "iH"'''
        self.assertEqual(swap_text("Hi"), "iH")

    def test_swap_text_6(self):
        '''swap_text("uLff yawtn soto grnazi e auspriresp rayt") --> "Luffy wants to organize a surprise party"'''
        self.assertEqual(swap_text("uLff yawtn soto grnazi e auspriresp rayt"), "Luffy wants to organize a surprise party")

    def test_swap_text_7(self):
        '''swap_text("😊😋😃😎") --> "😋😊😎😃"'''
        self.assertEqual(swap_text("😊😋😃😎"), "😋😊😎😃")

    def test_swap_text_8(self):
        '''swap_text ("321") --> "231"'''
        self.assertEqual(swap_text("321"), "231")

    def test_swap_text_9(self):
        '''swap_text ("hTsit se towkr s):") --> "This test works :)"'''
        self.assertEqual(swap_text("hTsit se towkr s):"), "This test works :)")
         
    def test_swap_text_10(self):
        '''swap_text ("     ") --> "     "'''
        self.assertEqual(swap_text("     "), "     ")
   
    ############################################################################
    # which_day tests - 10pts
    def test_which_day_1(self):
        '''which_day([3,4,7,8,1]) --> "Monday"'''
        self.assertEqual(which_day([3,4,7,8,1]), "Monday")

    def test_which_day_2(self):
        '''which_day([5,10,5]) --> "Sunday"'''
        self.assertEqual(which_day([5,10,5]), "Sunday")

    def test_which_day_3(self):
        '''which_day([-5]) --> "Friday"'''
        self.assertEqual(which_day([-5]), "Friday")

    def test_which_day_4(self):
        '''which_day([-63,7]) --> "Sunday"'''
        self.assertEqual(which_day([-63,7]), "Sunday")

    def test_which_day_5(self):
        '''which_day([0,0,1,1,-2]) --> "Tuesday"'''
        self.assertEqual(which_day([0,0,1,1,-2]), "Tuesday")

    def test_which_day_6(self):
        '''which_day([-3]) --> "Wednesday"'''
        self.assertEqual(which_day([-3]), "Wednesday")

    def test_which_day_7(self):
        '''which_day([1]) --> "Monday"'''
        self.assertEqual(which_day([1]), "Monday")

    def test_which_day_8(self):
        '''which_day([0,-4,2,-5]) --> "Thursday"'''
        self.assertEqual(which_day([0,-4,2,-5]), "Thursday")

    def test_which_day_9(self):
        '''which_day([-2,0,0]) --> "Tuesday"'''
        self.assertEqual(which_day([-2,0,0]), "Tuesday")

    def test_which_day_10(self):
        '''which_day([-7,5]) --> "Friday"'''
        self.assertEqual(which_day([-7,5]), "Friday")

    ############################################################################
  # delete_duplicates tests - 10pts
    def test_delete_duplicates_1(self):
        '''delete_duplicates(["cake", "napkins", "cake", "spoons", "cake"]) --> ['cake', 'napkins', 'spoons']'''
        self.assertEqual(delete_duplicates(["cake", "napkins", "cake", "spoons", "cake"]), ['cake', 'napkins', 'spoons'])

    def test_delete_duplicates_2(self):
        '''delete_duplicates() --> ['balloons', 'cake']'''
        self.assertEqual(delete_duplicates(["balloons", "balloons", "balloons", "cake"]), ['balloons', 'cake'])
    ...
    def test_delete_duplicates_4(self):
        '''delete_duplicates(["z","Z","z","a","A","a"]) --> ['z', 'Z', 'a', 'A']'''
        self.assertEqual(delete_duplicates(["z","Z","z","a","A","a"]), ['z', 'Z', 'a', 'A'])

    def test_delete_duplicates_5(self):
        '''delete_duplicates(["cake"]) --> ['cake']'''
        self.assertEqual(delete_duplicates(["cake"]), ['cake'])

    def test_delete_duplicates_6(self):
        '''delete_duplicates(["piñata","dulces","piñata"]) --> ['piñata', 'dulces']'''
        self.assertEqual(delete_duplicates(["piñata","dulces","piñata"]), ['piñata', 'dulces'])

    def test_delete_duplicates_7(self):
        '''delete_duplicates(["tacos","hambúrguer","tansan eumlyo", "", ""]) --> ['tacos', 'hambúrguer', 'tansan eumlyo', '']'''
        self.assertEqual(delete_duplicates(["tacos","hambúrguer","tansan eumlyo", "", ""]), ['tacos', 'hambúrguer', 'tansan eumlyo', ''])

    def test_delete_duplicates_8(self):
        '''delete_duplicates(["kek","Dàngāo","pastel"]) --> ['kek','Dàngāo','pastel']'''
        self.assertEqual(delete_duplicates(["kek","Dàngāo","pastel"]), ['kek','Dàngāo','pastel'])

    def test_delete_duplicates_9(self):
        '''delete_duplicates(["kik","kik","kik"]) --> ['kik']'''
        self.assertEqual(delete_duplicates(["kik","kik","kik"]), ['kik'])

    def test_delete_duplicates_10(self):
        '''delete_duplicates(["😋","😊","😊","😋"]) --> ['😋', '😊']'''
        self.assertEqual(delete_duplicates(["😋","😊","😊","😋"]), ['😋', '😊'])	

    ############################################################################
    # final_guests tests - 10pts
    def test_final_guests_1(self):
        '''final_guests(["Jinbe", "Silvers"], "Boa") --> ['Boa', 'Jinbe', 'Silvers']'''
        self.assertEqual(final_guests(["Jinbe", "Silvers"], "Boa"), ['Boa', 'Jinbe', 'Silvers'])

    def test_final_guests_2(self):
        '''final_guests(["Boa", "Koby", "Shanks"], "Jinbe") --> ['Boa', 'Jinbe', 'Koby', 'Shanks']'''
        self.assertEqual(final_guests(["Boa", "Koby", "Shanks"], "Jinbe"), ['Boa', 'Jinbe', 'Koby', 'Shanks'])

    def test_final_guests_3(self):
        '''final_guests([], "Koby") --> ['Koby']'''
        self.assertEqual(final_guests([], "Koby"), ['Koby'])

    def test_final_guests_4(self):
        '''final_guests([], "") --> ['']'''
        self.assertEqual(final_guests([], ""), [''])

    def test_final_guests_5(self):
        '''final_guests([""],"Sanji") --> ['', 'Sanji']'''
        self.assertEqual(final_guests([""],"Sanji"), ['', 'Sanji'])
        
    def test_final_guests_6(self):
        '''final_guests(["Ajay", "Koroush", "Nabit", "Renyuan"], "Arun") --> ['Ajay', 'Arun', 'Koroush', 'Nabit', 'Renyuan']'''
        self.assertEqual(final_guests(["Ajay", "Koroush", "Nabit", "Renyuan"], "Arun"), ['Ajay', 'Arun', 'Koroush', 'Nabit', 'Renyuan'])

    def test_final_guests_7(self):
        '''final_guests(["Aayush", "Archange", "Ebtesam", "Jialin"], "Mingxuan") --> ['Aayush', 'Archange', 'Ebtesam', 'Jialin', 'Mingxuan']'''
        self.assertEqual(final_guests(["Aayush", "Archange", "Ebtesam", "Jialin"], "Mingxuan"), ['Aayush', 'Archange', 'Ebtesam', 'Jialin', 'Mingxuan'])

    def test_final_guests_8(self):
        '''final_guests(["Ahho Zurako", "Barbarrosa"], "") --> ['', 'Ahho Zurako', 'Barbarrosa']'''
        self.assertEqual(final_guests(["Ahho Zurako", "Barbarrosa"], ""), ['', 'Ahho Zurako', 'Barbarrosa'])

    def test_final_guests_9(self):
        '''final_guests(["Ichiro Kumaguchi"], "Lucky Roux") --> ['Ichiro Kumaguchi', 'Lucky Roux']'''
        self.assertEqual(final_guests(["Ichiro Kumaguchi"], "Lucky Roux"), ['Ichiro Kumaguchi', 'Lucky Roux'])

    def test_final_guests_10(self):
        '''final_guests(["Black Widow", "Captain America", "Iron Man"], "Thanos") --> ['Black Widow', 'Captain America', 'Iron Man', 'Thanos']'''
        self.assertEqual(final_guests(["Black Widow", "Captain America", "Iron Man"], "Thanos"), ['Black Widow', 'Captain America', 'Iron Man', 'Thanos'])
