...
# 
#     python3 tester1.py yourfilehere.py
#
# (if you're on windows, instead use "python tester1.py yourfilehere.py").
# 
# This file needs the corresponding tests1.txt file to be in the
# same directory.
# 
