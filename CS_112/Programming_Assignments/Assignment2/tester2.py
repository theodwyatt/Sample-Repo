...
class AllTests (unittest.TestCase):
	...
	############################################################################
    # myMovieLife tests - 14pts
    def test_myMovieLife_1(self):
        '''myMovieLife('G',"Jan",6) --> "The True funny biography of a dreamer in 2 months"'''
        self.assertEqual(myMovieLife('G',"Jan",6), "The True funny biography of a dreamer in 2 months")

    def test_myMovieLife_2(self):
        '''myMovieLife('M',"Aug",3) --> "The False courageous existence of a movie star in 1 month"'''
        self.assertEqual(myMovieLife('M',"Aug",3), "The False courageous existence of a movie star in 1 month")

    def test_myMovieLife_3(self):
        '''myMovieLife('H',"Feb",6) --> "The True epic history of a dreamer in 2 months"'''
        self.assertEqual(myMovieLife('H',"Feb",6), "The True epic history of a dreamer in 2 months")

    def test_myMovieLife_4(self):
        '''myMovieLife('B',"Sep",0) --> "The True shocking battle of an adventurer in 1 month"'''
        self.assertEqual(myMovieLife('B',"Sep",0), "The True shocking battle of an adventurer in 1 month")

    def test_myMovieLife_5(self):
        '''myMovieLife('C',"Dec",8) --> "The True hilarious fairy tale of a jedi in 3 months"'''
        self.assertEqual(myMovieLife('C',"Dec",8), "The True hilarious fairy tale of a jedi in 3 months")

    def test_myMovieLife_6(self):
        '''myMovieLife('N',"Mar",2) --> "The True beautiful legend of a genius in 1 month"'''
        self.assertEqual(myMovieLife('N',"Mar",2), "The True beautiful legend of a genius in 1 month")

    def test_myMovieLife_7(self):
        '''myMovieLife('R',"Apr",5) --> "The False impressive life of a scientific in 5 months"'''
        self.assertEqual(myMovieLife('R',"Apr",5), "The False impressive life of a scientific in 5 months")

    def test_myMovieLife_8(self):
        '''myMovieLife('W',"Sep",0) --> "The True lovely battle of an adventurer in 1 month"'''
        self.assertEqual(myMovieLife('W',"Sep",0), "The True lovely battle of an adventurer in 1 month")

    def test_myMovieLife_9(self):
        '''myMovieLife('Q',"Jun",4) --> "The True dangerous revenge of a hero in 1 month"'''
        self.assertEqual(myMovieLife('Q',"Jun",4), "The True dangerous revenge of a hero in 1 month")
         
    def test_myMovieLife_10(self):
        '''myMovieLife('F',"May",3) --> "The False unbelievable anecdote of a movie star in 1 month"'''
        self.assertEqual(myMovieLife('F',"May",3), "The False unbelievable anecdote of a movie star in 1 month")
        
    def test_myMovieLife_11(self):
        '''myMovieLife('E',"Nov",9) --> "The False marvelous combat of an ogre in 25 months"'''
        self.assertEqual(myMovieLife('E',"Nov",9), "The False marvelous combat of an ogre in 25 months")
        
    def test_myMovieLife_12(self):
        '''myMovieLife('L',"Dec",7) --> "The False intriguing fairy tale of a cowboy in 12 months"'''
        self.assertEqual(myMovieLife('L',"Dec",7), "The False intriguing fairy tale of a cowboy in 12 months")
        
    def test_myMovieLife_13(self):
        '''myMovieLife('X',"Jul",1) --> "The False electrifying mission of a warrior in 1 month"'''
        self.assertEqual(myMovieLife('X',"Jul",1), "The False electrifying mission of a warrior in 1 month")

    def test_myMovieLife_14(self):
        '''myMovieLife('K',"Oct",1) --> "The False dramatic chronicle of a warrior in 1 month"'''
        self.assertEqual(myMovieLife('K',"Oct",1), "The False dramatic chronicle of a warrior in 1 month")     
    ...
    def test_status_2(self):
        "status(6) --> True"
        self.assertEqual(status(6), True)

    def test_status_3(self):
        "status(7) --> False"
        self.assertEqual(status(7), False)

    def test_status_4(self):
        "status(9) --> False"
        self.assertEqual(status(9), False)
	
    ############################################################################
    # adjective tests - 8pts
    def test_adjective_1(self):
        '''adjective('A') --> "awesome"'''
        self.assertEqual(adjective('A'), "awesome")

    def test_adjective_2(self):
        '''adjective('P') --> "lively"'''
        self.assertEqual(adjective('P'), "lively")

    def test_adjective_3(self):
        '''adjective('D') --> "fascinating"'''
        self.assertEqual(adjective('D'), "fascinating")

    def test_adjective_4(self):
        '''adjective('M') --> "courageous"'''
        self.assertEqual(adjective('M'), "courageous")

    def test_adjective_5(self):
        '''adjective('G') --> "funny"'''
        self.assertEqual(adjective('G'), "funny")

    def test_adjective_6(self):
        '''adjective('S') --> "astonishing"'''
        self.assertEqual(adjective('S'), "astonishing")

    def test_adjective_7(self):
        '''adjective('Z') --> "overwhelming"'''
        self.assertEqual(adjective('Z'), "overwhelming")

    def test_adjective_8(self):
        '''adjective('T') --> "interesting"'''
        self.assertEqual(adjective('T'), "interesting")
    
    ############################################################################
    # subject tests - 6pts
    def test_subject_1(self):
        '''subject("Jan") --> "biography"'''
        self.assertEqual(subject("Jan"), "biography")

    def test_subject_2(self):
        '''subject("Feb") --> "history'''
        self.assertEqual(subject("Feb"), "history")

    def test_subject_3(self):
        '''subject("Jun") --> "revenge"'''
        self.assertEqual(subject("Jun"), "revenge")

    def test_subject_4(self):
        '''subject("Jul") --> "mission"'''
        self.assertEqual(subject("Jul"), "mission")

    def test_subject_5(self):
        '''subject("Aug") --> "existence"'''
        self.assertEqual(subject("Aug"), "existence")
        
    def test_subject_6(self):
        '''subject("Sep") --> "battle"'''
        self.assertEqual(subject("Sep"), "battle")

    ############################################################################
    # complement tests - 4pts
    def test_complement_1(self):
        '''complement(0) --> "of an adventurer"'''
        self.assertEqual(complement(0), "of an adventurer")

    def test_complement_2(self):
        '''complement(3) --> "of a movie star"'''
        self.assertEqual(complement(3), "of a movie star")

    def test_complement_3(self):
        '''complement(8) --> "of a jedi"'''
        self.assertEqual(complement(8), "of a jedi")

    def test_complement_4(self):
        '''complement(9) --> "of an ogre"'''
        self.assertEqual(complement(9), "of an ogre")
    ...
    def test_months_2(self):
        '''months(1) --> 1'''
        self.assertEqual(months(1), 1)

    def test_months_3(self):
        '''months(9) --> 25'''
        self.assertEqual(months(9), 25)

    def test_months_4(self):
        '''Note this input months(11) --> 45 is only to verify if your math operations works for cases where days>725"'''
        self.assertEqual(months(11), 45)
    ############################################################################
